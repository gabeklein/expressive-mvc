  ...
  return (
    <div
      style={{
        ...
        display: 'flex',
        position: 'relative',
        background: 'linear-gradient(135deg, #14121f 0%, #191727 45%, #100e1a 100%)'
      }}>
      <div
        style={{
          position: 'absolute',
          inset: 0,
          background: 'radial-gradient(at 12% 108%, rgba(124, 92, 255, 0.16), transparent 55%)'
        }}
      />
      <div
        style={{
          position: 'absolute',
          inset: 0,
          background: 'radial-gradient(at 88% -10%, rgba(92, 110, 255, 0.14), transparent 55%)'
        }}
      />
      <svg
        width={470}
        ...
        style={{ position: 'absolute', left: 290, top: 348 }}>
        <path d={LOGO_PATH} fill="#9d74e8" />
      </svg>
      <div
        style={{
          position: 'absolute',
      ...
      <div
        ...
        <div
          ...
          <span>npm install @expressive/react</span>
        </div>
      </div>
    </div>
  );
