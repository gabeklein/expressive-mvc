...
Use **`Component`** when the behavior and the UI are inseparable - when the thing you're building _is_ a component, not data that happens to be displayed. Think: form controls, media players, animated canvases, data grids, layout shells.
