...
navigation blockers, external URLs, and data-router behavior are not part of
the supported contract yet. Keep ordinary anchors or the host router for a use
case that depends on one of those features.
