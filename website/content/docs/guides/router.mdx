...
package. An ordinary outer Route decides when the reusable feature is mounted;
the Router supplies an independent location and history to its internal Routes:
