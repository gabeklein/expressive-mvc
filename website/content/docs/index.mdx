...
<Cards>
  <Card title="Getting Started" href="/docs/getting-started" description="Install, build your first class, learn the mental model." />
  <Card title="Why Classes?" href="/docs/why-classes" description="The organizational argument for moving state out of components." />
  <Card title="Migrating from Hooks" href="/docs/migrating-from-hooks" description="A step-by-step playbook for adopting Expressive in an existing codebase." />
  <Card title="API Reference" href="/docs/api/state" description="Every method, instruction, and hook." />
</Cards>
