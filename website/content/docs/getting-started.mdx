...
Support is **provisional** — verified on Expo SDK 57 (React Native 0.86, React 19.2) for iOS and Android, including a Hermes bytecode build and re-render on write, but not yet on a device or simulator. Two things to know:
