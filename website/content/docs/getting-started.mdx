...
Support is **provisional** — a CI job builds an Expo SDK 57 app (React Native 0.86, React 19.2) and runs it on an iOS simulator, covering render and re-render on write, context, suspense and error recovery. Not yet run on a physical device. Two things to know:
