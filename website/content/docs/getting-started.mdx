...
The whole install is about **11 kB** gzip with everything imported, and closer to **9 kB** for a typical app. Numbers are measured per import shape and gated in CI — see [Bundle size](/docs/guides/bundle-size).
