...
// map.MapLike<K, V>: key-addressed reads, removal, entry iteration, transforms - no insertion verb
// map.SetLike<V>: value-identity reads, removal, value iteration - no insertion verb
