...
// MapLike: key-addressed reads, removal, entry iteration, transforms - no insertion verb
// SetLike: value-identity reads, removal, value iteration - no insertion verb
