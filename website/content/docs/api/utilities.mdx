...
Mark model writes as non-urgent presentation work. The callback itself runs synchronously; subscriber callbacks retain the designation when they run in the normal microtask dispatch.
