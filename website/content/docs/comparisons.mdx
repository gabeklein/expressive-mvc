...
export const faq = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The commit history predates the release: development ran unannounced from 2021, and the public launch - documentation site, stable API surface, published adapters - is 2026. Coverage is a CI-enforced, measured 100% of lines across every package.',
      },
    },
  ],
};
