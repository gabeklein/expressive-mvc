...
function get <R, T extends Model> (Type: Model.Type<T>, compute: (this: T, on: T) => R, suspend: true): Exclude<R, undefined>;
function get <R, T extends Model> (Type: Model.Type<T>, compute: (this: T, on: T) => R, suspend?: boolean): R;
