 ...
 */
export function from <R> (compute: (property: string) => (this: any, state: any) => R): R;
 ...
 * Will update automatically as input values change.
 */
export function from <T, R> (source: T, compute: (this: T, on: T) => R): R;
 ...
 */
 export function pending <T, R> (source: T, compute: (this: T, on: T) => R): Exclude<R, undefined>;