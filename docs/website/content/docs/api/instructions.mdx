---
title: Instructions
description: Property initializers — ref, def, get, set — all overloads
---

Instructions are special initializers for class fields. They wire up reactive behavior declaratively.

```ts
import { def, ref, get, set } from '@expressive/react';
```
...
Base instruction defining custom property behavior during initialization.
