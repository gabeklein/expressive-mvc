 ...
 *
 * @param reactive - Pass `true` to enable reactive mode with implicit this
 ...
 *
 * @param source - Source state from which computed value will be a subscriber.
 ...
 */
function set<R, T extends State>(source: T, compute: set.Compute<R, T>): R;
