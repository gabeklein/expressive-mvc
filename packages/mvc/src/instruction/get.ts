 ...
 */
function get <T extends Model> (Type: get.Type<T>, asParent?: true): T;
 ...
 */
function get <T extends Model> (Type: get.Type<T>, required?: false): T | undefined;
 ...
 */
function get <R, T extends Model> (Type: get.Type<T>, compute: get.Function<R, T>): R;
