...
declare namespace get {
  ...
  type Callback<T, S = any> = (model: S, key: string) => ((next: T) => void) | void;
}
 ...
 */
function get <R, T extends Model> (Type: Model.Type<T>, compute: get.Callback<R, T>): R;
    ...
    if(Model.is(arg0)){
      ...
      const assign = (value: T) => {
        ...
        if(typeof arg1 == "function")
          cb = (arg1 as get.Callback<T>)(value, key);
