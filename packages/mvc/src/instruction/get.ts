...
type Type<T extends Model> = Model.Extends<T> & typeof Model;
 ...
 */
function get<T extends Model>(Type: Model.Extends<T>, expectParent?: true): T;
 ...
 */
function get<T extends Model>(Type: Model.Extends<T>, effect: get.Effect<T>): T;
