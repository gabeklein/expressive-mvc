 ...
 */
function get <T extends Model> (Type: Model.Infer<T>, asParent?: true): T;
 ...
 */
function get <T extends Model> (Type: Model.Infer<T>, required?: false): T | undefined;
 ...
 */
function get <R, T extends Model> (Type: Model.Infer<T>, compute: get.Function<R, T>): R;
...
function get<R, T extends Model>(
  arg0: T | get.Factory<R, T> | get.Type<T>,
