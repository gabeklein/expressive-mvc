...
declare module '@expressive/mvc' {
  namespace Model {
    ...
    function as <T extends Model, P extends Model.Assign<T>> (
      this: Model.Init<T>, render: Pragma.FC<P>
...
declare namespace Provider {
  ...
  interface NormalProps<E, I = Instance<E>> extends Pragma.ComponentProps {
    for: E;
    use?: Model.Assign<I>;
  }

  // FIX: This fails to exclude properties with same key but different type.
  interface MultipleProps<T extends Item> extends Pragma.ComponentProps {
    for: Multiple<T>;
...
declare namespace Consumer {
  ...
  interface RenderProps<T extends Model> extends Pragma.RenderProps<T> {
    /** Type of controller to fetch from context. */
    for: Model.Type<T>;
  }
