...
declare module '@expressive/mvc' {
  namespace Model {
    ...
    function as <T extends Model, P extends Model.Assign<T>> (
      this: Model.Init<T>, render: (using: P) => VNode<any> | null
...
declare namespace Provider {
  ...
  type Instance<E> = E extends (new () => any)
    ? InstanceType<E> : E extends Model ? E : never;
...
declare const Provider: FunctionComponent<Provider.Props>;
...
declare namespace Consumer {
  ...
  type RenderProps<T extends Model> = {
     ...
     */
    children: (value: T) => VNode<any> | null;
  }

  type Props<T extends Model = Model> = HasProps<T> | GetProps<T> | RenderProps<T>
}

declare const Consumer: FunctionComponent<Consumer.Props>;
