...
Explore fully working examples to see Expressive MVC in action:

### [Form Management](https://codesandbox.io/s/github/gabeklein/expressive-mvc/tree/main/examples/form-management)

Generic form state management with validation, error handling, and field tracking. Demonstrates reusable patterns for building type-safe forms.

### [Todo List with Nested States](https://codesandbox.io/s/github/gabeklein/expressive-mvc/tree/main/examples/todo-list)

Classic todo list showcasing nested State instances, computed properties for derived values, and fine-grained reactivity.

### [Multi-Step Wizard](https://codesandbox.io/s/github/gabeklein/expressive-mvc/tree/main/examples/wizard)

Step-by-step form flow with validation, computed navigation state, and comprehensive step management.
