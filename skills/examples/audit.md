...
- **"It's been around for years without gaining traction"** - the commit history predates the release: development ran unannounced from 2021, and the public launch (docs site, stable API, published adapters) is 2026. Adoption metrics are meaningful from the release window, not the first commit.
